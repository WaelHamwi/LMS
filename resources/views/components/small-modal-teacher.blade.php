        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mb-3">
                    ...
                    <img id="modalImage" src="{{ asset('attachments/teachers/' . $teacher->first_name . '/' . $image->filename) }}" alt="Image preview" class="img-fluid rounded">
                    @else
                ...
                @if(isset($imageId))
                <form id="editImageForm" enctype="multipart/form-data" action="{{ route('image.updateTeacherImage', ['id' => $imageId]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <input type="text" id="imageFilename" name="filename" class="form-control mb-3"
                        value="{{ $image && $image->filename ? asset('attachments/teachers/' . $teacher->first_name . '/' . $image->filename) : '' }}"
