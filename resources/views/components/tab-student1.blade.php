        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- Edit Button -->
                    @php
                    $image = $student->images->isNotEmpty() ? $student->images[0] : null;
                    @endphp
                    ...
                    <div class="student-profile-head">
                        <div class="profile-bg-img">
                            ...
                            <img src="{{ $profileImage && $profileImage->filename ? asset('attachments/students/' . $student->name . '/' . $profileImage->filename) : asset('assets/img/profile-bg.jpg') }}" alt="Profile Image" class="img-fluid" style="object-fit: cover; width: 100%; height: 100%;">
                        </div>
                                ...
                                <div class="profile-user-box">
                                    <div class="profile-user-img ">
                                        ...
                                        <div class="form-group students-up-files mb-0 position-relative">
                                            <img src="{{ $profileImage && $profileImage->filename ? asset('attachments/students/' . $student->name . '/' . $profileImage->filename) : asset('assets/img/profile-user.jpg') }}" alt="Profile Image" class="img-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="personal-activity">
                                    ...
                                    <div class="views-personal">
                                        <h4>Mobile</h4>
                                        <h5>{{ $student->parent->father_phone }}</h5>
                                    </div>
                                </div>
                                <div class="personal-activity">
                                    <div class="personal-icons">
