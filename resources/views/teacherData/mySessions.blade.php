        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    'formAction' => route('teacher_sessions.store'),
                    'fields' => [
                    [
                    ...
                    'formAction' => route('teacher_sessions.store_indirect_integration'),
            ...
            $modelName = 'Teacher Session';
            $routeDestroy = 'teacher_sessions.destroy';
            ...
            return '
            <form action="' . route('teacher_sessions.destroySession', ['id' => $row['data'][0]]) . '" method="POST" style="display: inline-block;">
                ' . csrf_field() . '
                ' . method_field('DELETE') . '
                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                    ...
                    data-action="delete"
                    data-url="' . route('teacher_sessions.destroySession', ['id' => $row['data'][0]]) . '">
                    Delete
                </button>
            </form>';
            };
