        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    'formId' => 'exam-teacher-form',
                    'formAction' => route('teacherExams.storeExam'),
                    'fields' => [
                    [
            ...
            $modelName = 'Exam';
            $routeDestroy = 'teacherExams.destroy';
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton-' . $row['data'][0] . '">
                    ...
                    <li>
                        <form action="' . route('teacherExams.destroy', $row['data'][0]) . '" method="POST" style="display: inline-block;">
                            ' . csrf_field() . '
                            ' . method_field('DELETE') . '
                            <button type="button" class="dropdown-item text-danger"
                                ...
                                data-action="delete"
                                data-url="' . route('teacherExams.destroy', $row['data'][0]) . '">
                                <i class="fas fa-trash-alt me-2"></i> Delete
                            </button>
                        </form>
                    </li>
                    <li>
                        <a href="' . route('teacherExams.studentsCompleted', $row['data'][0]) . '" class="dropdown-item text-info">
